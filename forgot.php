...
<style>
body {font-family: Arial, Helvetica, sans-serif;background: url(images/d2.jpg);
...
<body>
  ...
  <form class="modal-content animate" action="recpsw.php" method="post">
    <div class="imgcontainer">
      <span onclick=window.open("index.php","_self") class="close" title="Close Modal">&times;</span>
      <img src="images/a.png" alt="Avatar" class="avatar">
    </div>
